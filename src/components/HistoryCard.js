  ...
  return (
    <View style={styles.card}>
      ...
      <View style={styles.actions}>
        {isActive ? <PrimaryButton title="Tôi đã an toàn" variant="success" onPress={onMarkSafe} style={styles.actionButton} /> : null}
        <PrimaryButton title="Chia sẻ lại" variant="outline" onPress={onShare} style={styles.actionButton} />
      </View>
    </View>
  );
}
